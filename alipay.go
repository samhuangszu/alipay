...
func New(appId, partnerId, aliPublicKey, appPrivateKey string, appPublicKey string, isProduction bool) (client *AliPay) {
	client = &AliPay{}
	client.appId = appId
	client.partnerId = partnerId
	client.appPrivateKey = encoding.ParsePrivateKey(appPrivateKey)
